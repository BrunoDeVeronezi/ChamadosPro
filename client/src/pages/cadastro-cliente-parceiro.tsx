...
export default function CadastroClienteParceiro() {
  ...
  const [formData, setFormData] = useState({
    ...
    defaultAdditionalHourRate: '',
    defaultKmRate: '',
    monthlySpreadsheetEnabled: false,
    monthlySpreadsheetEmail: '',
  ...
  const createMutation = useMutation({
    mutationFn: async (data: typeof formData) => {
      const response = await apiRequest('POST', '/api/clients/partner', data);
      if (!response.ok) {
        const error = await response.json();
        throw new Error(error.message || 'Erro ao cadastrar cliente parceiro');
      }
    ...
    onSuccess: () => {
      ...
      toast({
        title: 'Cliente parceiro cadastrado',
        description: 'O cliente parceiro foi cadastrado com sucesso.',
      });
    ...
    onError: (error: any) => {
      toast({
        variant: 'destructive',
        title: 'Erro ao cadastrar cliente parceiro',
      ...
      <div className='flex h-full grow'>
        <main className='flex-1 p-8 overflow-y-auto'>
          <div className='max-w-4xl mx-auto'>
            ...
            <Card className='bg-white dark:bg-gray-900/50 rounded-xl shadow-sm p-8 space-y-8'>
              <form onSubmit={handleSubmit} className='space-y-8'>
                ...
                <div className='space-y-6'>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <div className='flex flex-col'>
                      ...
                      <Input
                        className='flex h-12 w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#111418] dark:text-white focus:outline-0 focus:ring-2 focus:ring-[#3880f5]/50 border border-[#dbdfe6] dark:border-gray-700 bg-white dark:bg-gray-800 focus:border-[#3880f5] h-12 placeholder:text-[#60708a] px-4 text-base font-normal leading-normal'
                ...
                <div className='space-y-6'>
                  ...
                  <div className='flex items-center justify-between'>
                    <div className='flex flex-col'>
                      <Label className='text-[#111418] dark:text-white font-medium'>
