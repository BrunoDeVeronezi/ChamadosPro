...
export default function CadastroClienteManual() {
  ...
  const handleCnpjBlur = async () => {
    ...
    try {
      ...
      setFormData((prev) => {
        ...
        if (data.numero && (!prev.number || prev.number.trim() === '')) {
          updated.number = String(data.numero);
        }
        if (data.complemento && (!prev.complement || prev.complement.trim() === '')) {
          updated.complement = String(data.complemento).trim();
        }
        return updated;
      });
    } catch (error) {
  ...
  return (
    <div className='relative flex h-auto min-h-screen w-full flex-col bg-[#f5f7f8] dark:bg-[#101722] font-display overflow-x-hidden'>
      <div className='layout-container flex h-full grow flex-col'>
        <header className='flex w-full items-center justify-center border-b border-solid border-gray-200 dark:border-gray-800 bg-white dark:bg-[#101722] px-4 sm:px-6 lg:px-8'>
          <div className='flex w-full max-w-7xl items-center justify-between whitespace-nowrap py-3'>
            <div className='flex items-center gap-4 text-gray-900 dark:text-white'>
              <div className='h-6 w-6 text-[#3880f5]'>
                <svg
                  fill='none'
                  viewBox='0 0 48 48'
            ...
            <nav className='hidden items-center gap-9 md:flex'>
              <Link href='/'>
                <a className='text-sm font-medium leading-normal text-gray-600 dark:text-gray-400 hover:text-[#3880f5] dark:hover:text-[#3880f5]'>
                  Dashboard
                </a>
              </Link>
              <Link href='/clientes'>
                <a className='text-sm font-medium leading-normal text-[#3880f5]'>
                  Clientes
                </a>
              </Link>
              <Link href='/chamados'>
          ...
          <div className='layout-content-container flex w-full max-w-3xl flex-1 flex-col gap-8'>
            <div className='flex flex-col gap-2'>
              <h1 className='text-4xl font-black leading-tight tracking-[-0.033em] text-gray-900 dark:text-white'>
                Cadastro/Edição Manual de Cliente
              </h1>
            </div>

            {/* Tipo de Cliente */}
            <Card className='flex flex-col gap-6 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#101722]/50 p-6 shadow-sm'>
              <div className='flex flex-col gap-2'>
                <Label className='text-base font-medium leading-normal text-gray-900 dark:text-white'>
                  Tipo de Cliente
                </Label>
                <div className='flex h-10 w-full items-center justify-center rounded-lg bg-[#f5f7f8] dark:bg-[#101722] p-1'>
                  <label
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-6'>
              ...
              <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
                <div className='flex flex-col flex-1'>
                  ...
                  <Input
                    className='flex h-12 w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 p-3 text-base font-normal leading-normal text-gray-900 dark:text-white placeholder-gray-500 focus:border-[#3880f5] focus:outline-none focus:ring-2 focus:ring-[#3880f5]/20'
                    placeholder={
                      clientType === 'PF'
              ...
              <div className='flex flex-col gap-6'>
                ...
                <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
                  ...
                  <div className='flex flex-col flex-1'>
                    ...
                    >
                      <SelectTrigger className='flex h-12 w-full min-w-0 flex-1 cursor-pointer resize-none items-center overflow-hidden rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 p-3 text-base font-normal leading-normal text-gray-900 dark:text-white focus:border-[#3880f5] focus:outline-none focus:ring-2 focus:ring-[#3880f5]/20'>
              ...
              <div className='flex flex-wrap items-center justify-end gap-4 pt-4'>
                ...
                <Button
                  type='submit'
                  className='flex h-11 items-center justify-center rounded-lg bg-[#3880f5] px-6 text-sm font-medium text-white shadow-sm hover:bg-[#3880f5]/90'
