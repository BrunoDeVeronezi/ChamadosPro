...
export default function RelatoriosAvancados2() {
  ...
  return (
    <div className='relative flex h-auto min-h-screen w-full flex-col bg-[#f5f7f8] dark:bg-[#101722] font-display text-gray-800 dark:text-gray-200 overflow-x-hidden'>
          ...
          <div className='max-w-7xl mx-auto'>
            <div className='flex flex-wrap justify-between items-start gap-4 mb-6'>
              <div className='flex flex-col gap-2'>
                ...
                <p className='text-[#60708a] dark:text-gray-400 text-base font-normal'>
            ...
            {/* Filtros */}
            <div className='flex flex-wrap gap-3 mb-6 border-b border-gray-200 dark:border-gray-800 pb-6'>
              <Select value={period} onValueChange={setPeriod}>
                <SelectTrigger className='h-8 shrink-0 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-[#111418] dark:text-gray-200 hover:border-gray-300 dark:hover:border-gray-600'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6'>
              <Card className='flex flex-col gap-2 rounded-xl p-6 border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/50'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
              <Card className='flex w-full flex-col gap-2 rounded-xl border border-gray-200 dark:border-gray-800 p-6 bg-white dark:bg-gray-900/50'>
              ...
              <Card className='flex w-full flex-col gap-2 rounded-xl border border-gray-200 dark:border-gray-800 p-6 bg-white dark:bg-gray-900/50'>
                ...
                <div className='grid min-h-[240px] gap-x-4 gap-y-3 grid-cols-[auto_1fr] items-center pt-4'>
                  {[
                    ...
                    <>
                      <p className='text-gray-500 dark:text-gray-400 text-xs font-bold tracking-wider'>
                        {client}
                      </p>
              ...
              <Card className='flex w-full flex-col gap-2 rounded-xl border border-gray-200 dark:border-gray-800 p-6 bg-white dark:bg-gray-900/50 lg:col-span-2'>
                <p className='text-[#111418] dark:text-white text-base font-medium'>
                ...
                <div className='flex min-h-[240px] flex-1 flex-col gap-4 py-4'>
                  ...
                  <div className='flex justify-between -mt-4 px-2'>
                    {[
                      ...
                      <p
                        key={month}
                        className='text-gray-500 dark:text-gray-400 text-xs font-bold tracking-wider'
                      >
                        {month}
                      </p>
                    ))}
