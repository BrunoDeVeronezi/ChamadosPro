...
export default function CadastroClienteManual2() {
  ...
  return (
    <div className='relative flex h-auto min-h-screen w-full flex-col bg-background-dark font-display overflow-x-hidden'>
      <div className='layout-container flex h-full grow flex-col'>
        <header className='flex w-full items-center justify-center border-b border-solid border-gray-800 bg-background-dark px-4 sm:px-6 lg:px-8'>
          <div className='flex w-full max-w-7xl items-center justify-between whitespace-nowrap py-3'>
            ...
            <nav className='hidden items-center gap-9 md:flex'>
              <a
                className='text-sm font-medium leading-normal text-gray-400 hover:text-primary'
                href='#'
              >
                Dashboard
              </a>
        ...
        <main className='flex flex-1 justify-center py-10 px-4 sm:px-6 lg:px-8'>
          <div className='layout-content-container flex w-full max-w-3xl flex-1 flex-col gap-8'>
            ...
            <Card className='flex flex-col gap-6 rounded-xl border border-gray-800 bg-[#171E2A]/50 p-6 shadow-sm'>
              <div className='flex flex-col gap-2'>
                <Label className='text-base font-medium leading-normal text-white'>
                  Tipo de Cliente
                </Label>
                <div className='flex h-10 w-full items-center justify-center rounded-lg bg-background-dark p-1'>
                  <label
              ...
              <form onSubmit={handleSubmit} className='flex flex-col gap-6'>
                <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
                  <div className='flex flex-col flex-1'>
                    ...
                    <Input
                      className='flex h-12 w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg border border-gray-700 bg-gray-800 p-3 text-base font-normal leading-normal text-white placeholder-gray-500 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20'
                      placeholder={
                        clientType === 'PF'
                ...
                <div className='flex flex-col gap-6'>
                  ...
                  <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
                    ...
                    <div className='flex flex-col flex-1'>
                      ...
                      >
                        <SelectTrigger className='flex h-12 w-full min-w-0 flex-1 cursor-pointer resize-none items-center overflow-hidden rounded-lg border border-gray-700 bg-gray-800 p-3 text-base font-normal leading-normal text-white focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20'>
                ...
                <div className='flex flex-wrap items-center justify-end gap-4 pt-4'>
                  <Button
                    type='button'
                    variant='ghost'
                    className='flex h-11 items-center justify-center rounded-lg bg-transparent px-6 text-sm font-medium text-gray-300 hover:bg-gray-800'
                  ...
                  <Button
                    type='submit'
                    className='flex h-11 items-center justify-center rounded-lg bg-background-light px-6 text-sm font-medium text-background-dark shadow-sm hover:bg-background-light/90'
        ...
        <footer className='flex w-full items-center justify-center py-6 px-4 sm:px-6 lg:px-8'>
          <p className='text-sm text-gray-400'>© 2024 ChamadosPro</p>
        </footer>
      </div>
    </div>
  );
