...
export default function SincronizacaoGoogleCalendar2() {
  ...
  return (
    <div className='relative flex min-h-screen w-full bg-white dark:bg-[#101722] font-display text-[#111418] dark:text-white/90'>
      <main className='flex-1 p-8 overflow-y-auto'>
        <div className='max-w-4xl mx-auto'>
          <div className='flex flex-wrap justify-between gap-4 mb-8'>
            <div className='flex flex-col gap-2'>
              <h1 className='text-[#111418] dark:text-white/90 text-3xl font-bold leading-tight tracking-tight'>
                Sincronização com Google Calendar
              </h1>
              <p className='text-[#60708a] dark:text-white/60 text-base font-normal leading-normal'>
          ...
          {/* Status da Conexão */}
          <Card className='mb-8 flex flex-col items-start justify-between gap-4 rounded-lg border border-black/10 dark:border-white/10 bg-white dark:bg-[#161f2c] p-5 md:flex-row md:items-center'>
            <div className='flex flex-col gap-1'>
              <p className='text-[#111418] dark:text-white/90 text-base font-bold leading-tight'>
                Status da Conexão
              </p>
              <div className='flex items-center gap-2'>
                {settings.connected ? (
                  <>
                    ...
                    <p className='text-[#60708a] dark:text-white/60 text-sm font-normal leading-normal'>
          ...
          {settings.connected && (
            <form onSubmit={handleSubmit} className='space-y-8'>
              ...
              <Card className='bg-white dark:bg-[#101722] border border-black/10 dark:border-white/10 rounded-lg'>
                <div className='flex items-center gap-4 px-5 py-4 min-h-14 justify-between'>
                  <div className='flex items-center gap-4'>
                    ...
                    <div className='flex flex-col'>
                      <Label className='text-[#111418] dark:text-white/90 text-base font-medium leading-normal flex-1 truncate'>
                        Ativar Sincronização Bidirecional
                      </Label>
                      <p className='text-[#60708a] dark:text-white/60 text-sm'>
              ...
              <Card className='bg-white dark:bg-[#101722] border border-black/10 dark:border-white/10 rounded-lg'>
                <h2 className='text-[#111418] dark:text-white/90 text-lg font-bold leading-tight px-5 pb-3 pt-5 border-b border-black/10 dark:border-white/10'>
                  Sincronização ChamadosPro → Google Calendar
                </h2>
                <div className='p-5 space-y-4'>
                  <p className='text-sm text-[#60708a] dark:text-white/60'>
                  ...
                  >
                    <div className='flex items-center gap-3'>
                      <RadioGroupItem
                        value='scheduled'
                        id='sync-scheduled'
                        className='text-[#3880f5] focus:ring-[#3880f5]/50 bg-transparent border-black/30 dark:border-white/30'
                      />
                      <Label
                        htmlFor='sync-scheduled'
                        className='text-[#111418] dark:text-white/90 text-sm cursor-pointer'
                      >
                ...
                <div className='p-5 space-y-4'>
                  ...
                  >
                    ...
                    <div className='flex flex-col gap-2'>
                      ...
                      <Input
                        className='w-full max-w-xs ml-7 rounded-md border-black/20 dark:border-white/20 shadow-sm focus:border-[#3880f5] focus:ring-[#3880f5]/50 bg-transparent text-[#111418] dark:text-white/90 text-sm'
              ...
              <div className='flex justify-end gap-3 pt-4'>
                <Button
                  type='button'
                  variant='outline'
                  className='bg-black/5 dark:bg-white/10 text-[#111418] dark:text-white/90 hover:bg-black/10 dark:hover:bg-white/20'
